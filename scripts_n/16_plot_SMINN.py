...
for i in xrange(1):
   ...
   cbar.ax.set_xlabel('g N m$^{-2}$', rotation=0,color='black', size=78, fontname='Times')
   ...
   plt.title(r'Soil N', fontname='Times', fontsize=92,pad=26)
   cbar.ax.tick_params(labelsize='xx-large')
   #plt.savefig('em_steindinger_tot.pdf',bbox_inches="tight",dpi=300)
   plt.savefig('figures/Nitrogen/SMINN.png',bbox_inches="tight")
