...
lon = f.variables['lon'][:]
gpp = f.variables['GPP'][:]
#pactive = f.variables['NFIX'][:]
pactive = f.variables['FFIX_TO_SMINN'][:]
...
for i in xrange(1):
   ...
   plt.title(r'Symbiotic fixation', fontname='Times', fontsize=92*1.5,pad=26)
   cbar.ax.tick_params(labelsize=92)
   #plt.savefig('em_steindinger_tot.pdf',bbox_inches="tight",dpi=300)
   #plt.savefig('figures/Nitrogen/NFIX.png',bbox_inches="tight")
   plt.savefig('/home/renato/Desktop/NFIX.png',bbox_inches="tight")
