...
#nfix_ori[nfix_ori == 1]=np.nan
#nfix_ori[nfix_ori == 0]=np.nan


#for i in xrange(16):
#   plt.imshow(pactive_ori[i,:,:])
#   plt.show()
#sys.exit()
...
#($\div$ 100)
plt.ticklabel_format(axis="y",style="sci",scilimits=(0,0))
plt.savefig('figures/Nitrogen/COST_NUPTAKE_zonal_pft_b.png',bbox_inches="tight")
#plt.show()
