...
data2 = []
for i in range(17):
  print("Interpolating %s ..." % pftname_fig[i])
...
for i in range(17):
   print("Masking oceans of %s ..." % pftname_fig[i])
...
for i in range(17):
   ...
   plt.title(r'%s' % pftname_fig[i], fontname='Times', fontsize=92,pad=26)
   cbar.ax.tick_params(labelsize='xx-large')
   #plt.savefig('em_steindinger_tot.pdf',bbox_inches="tight",dpi=300)
   plt.savefig('figures/PFT_%s.png' % pftname_fig[i],bbox_inches="tight")
