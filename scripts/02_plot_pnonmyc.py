...
v = pactive[:,:]*365*24*60*60*1


print(np.nanmean(v),'gPm-2yr-1')
...
for i in range(1):
   ...
   plt.title(r'Direct root uptake', fontname='Times', fontsize=92*1.5,pad=26)
   cbar.ax.tick_params(labelsize=92)
   #plt.savefig('em_steindinger_tot.pdf',bbox_inches="tight",dpi=300)
   plt.savefig('figures/PNONMYC.png',bbox_inches="tight")
