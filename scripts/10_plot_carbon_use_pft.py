...
cost_nonmyc_ori = f.variables['COST_PNONMYC'][:]
cost_active_ori = f.variables['COST_PACTIVE'][:]
cost_retrans_ori = f.variables['COST_PRETRANS'][:]
...
pnonmyc_ori = f.variables['NPP_PNONMYC'][:]
pactive_ori = f.variables['NPP_PACTIVE'][:]
pretrans_ori = f.variables['NPP_PRETRANS'][:]
