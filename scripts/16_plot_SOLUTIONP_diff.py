...
lon = f.variables['lon'][:]
gpp = f.variables['GPP'][:]
npp_elm = f1.variables['SOLUTIONP'][:]
npp_fun = f.variables['SOLUTIONP'][:]
...
for i in xrange(1):
   ...
   cbar.ax.set_xlabel('mg P m$^{-2}$', rotation=0,color='black', size=78, fontname='Times')
   ...
   plt.savefig('figures/delta_SOLUTIONP.png',bbox_inches="tight")
