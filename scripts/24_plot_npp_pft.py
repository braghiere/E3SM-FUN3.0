...
pnonmyc_ori = f.variables['NPP'][:]
pactive_ori = f1.variables['NPP'][:]
pactive_ori = np.nanmean(pactive_ori,axis=0)
pretrans_ori = f.variables['NPP'][:]
...
p1 = plt.bar(ind-width/2, np.array(pactive_mean), width, color = 'b',edgecolor='k',linewidth=3.3)

p2 = plt.bar(ind+width/2, np.array(pnonmyc_mean), width, color = 'r',edgecolor='k',linewidth=3.3)
...
plt.legend((p1[0],p2[0]),('E3SMv1','E3SMv1-FUN3.0'))
#($\div$ 100)
plt.ticklabel_format(axis="y",style="sci",scilimits=(0,0))
plt.tight_layout()
plt.savefig('figures/24_npp_pft_all.png')
plt.close()
#sys.exit()
...
print('E3SMv1-FUN3.0 - NPP',pnonmyc_arr_glob,pnonmyc_arr_glob/tot)
print('E3SMv1 - NPP',pactive_arr_glob,pactive_arr_glob/tot)

print('total change',np.array(pnonmyc_arr_glob)-np.array(pactive_arr_glob))
print('Percent change',100.*(np.array(pnonmyc_arr_glob)-np.array(pactive_arr_glob))/np.array(pactive_arr_glob))
...
p2 = plt.bar(ind+width, np.array(pnonmyc_arr_glob), width, color = 'r',edgecolor='k',linewidth=3.3)
...
plt.savefig('figures/24_npp_pft.png',bbox_inches="tight")
#plt.show()
