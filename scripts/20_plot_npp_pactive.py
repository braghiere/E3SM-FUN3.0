...
lon = f.variables['lon'][:]
gpp = f.variables['GPP'][:]
pactive = f.variables['NPP_PACTIVE'][:]
...
for i in xrange(1):
   ...
   plt.title(r'NPP spent on Mycorrhizal uptake', fontname='Times', fontsize=92,pad=26)
   cbar.ax.tick_params(labelsize='xx-large')
   #plt.savefig('em_steindinger_tot.pdf',bbox_inches="tight",dpi=300)
   plt.savefig('figures/NPP_PACTIVE.png',bbox_inches="tight")
