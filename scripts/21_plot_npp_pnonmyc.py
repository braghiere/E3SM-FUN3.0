...
print('npp_pnonmyc',np.nanmean(v),'gCm-2yr-1')
...
for i in range(1):
   ...
   plt.title(r'NPP spent on Direct root uptake', fontname='Times', fontsize=92,pad=26)
   cbar.ax.tick_params(labelsize='xx-large')
   #plt.savefig('em_steindinger_tot.pdf',bbox_inches="tight",dpi=300)
   plt.savefig('figures/NPP_PNONMYC.png',bbox_inches="tight")
