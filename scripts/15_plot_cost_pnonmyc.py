...
lon = f.variables['lon'][:]
gpp = f.variables['GPP'][:]
pactive = f.variables['COST_PNONMYC'][:]
...
print('Cost_pnonmyc',np.nanmean(v),'gP/gC')
...
for i in range(1):
   ...
   plt.title(r'C cost of Direct root uptake', fontname='Times', fontsize=92,pad=26)
   cbar.ax.tick_params(labelsize='xx-large')
   #plt.savefig('em_steindinger_tot.pdf',bbox_inches="tight",dpi=300)
   plt.savefig('figures/COST_PNONMYC.png',bbox_inches="tight")
