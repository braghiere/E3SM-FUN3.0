...
lon = f.variables['lon'][:]
gpp = f.variables['GPP'][:]
npp_elm = f1.variables['AR'][:]
npp_fun = f.variables['AR'][:]
...
npp_diff = (npp_fun - npp_elm)*(365*24*60*60)
...
for i in xrange(1):
   ...
   plt.title(r'$\Delta$ Autotrophic Respiration', fontname='Times', fontsize=92,pad=26)
   cbar.ax.tick_params(labelsize='xx-large')
   #plt.savefig('em_steindinger_tot.pdf',bbox_inches="tight",dpi=300)
   plt.savefig('figures/delta_auto_resp.png',bbox_inches="tight")
...
for i in xrange(1):
   ...
   cbar.ax.tick_params(labelsize='xx-large')
   #plt.savefig('em_steindinger_tot.pdf',bbox_inches="tight",dpi=300)
   plt.savefig('figures/delta_auto_resp_rel.png',bbox_inches="tight")
   #plt.savefig('ecm_orig_shi_1p9x2p5.png',bbox_inches="tight",dpi=300)
   #plt.show()
