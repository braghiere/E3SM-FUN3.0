...
f = Dataset('/home/renato/ELM_FUNP/fix_global_v6_1994_2005/files/fix_global_v6_funp_time_avg.nc','r')
f11 = Dataset('/home/renato/ELM_FUNP/fix_global_v6_1994_2005/files/fix_global_v6_fun_time_avg.nc','r')
f0 = Dataset('/home/renato/ELM_FUNP/fix_global_v3_1994_2005/files/fix_global_v3_time_avg.nc','r')
...
plt.plot(lat,nlim,'k',linewidth=9.3,label="Fisher et al. (2012)")
plt.plot(lat,nutri_lim_n,linewidth=9.3,color='darkorange',label="E3SM-FUN2")
plt.plot(lat,nutri_lim_np,linewidth=9.3,color='green',label="E3SM-FUN3")
plt.legend()
...
plt.xlabel(r'Latitude',fontsize = 92)
plt.ylabel(r'Normalized C use ratio for nutrient uptake (%)' ,fontsize = 92)

#plt.show()
#plt.savefig('zonal_fisher2012.png',bbox_inches="tight")
...
plt.scatter(nlim,nutri_lim_n,label=r'E3SM-FUN2 (R$^{2}$ = %.2f; RMSE = %.2f; slope = %.2f)' % (r2, rmse2, slope2),linewidth=9.3,s=600,color='darkorange')
plt.scatter(nlim,nutri_lim_np,label=r'E3SM-FUN3 (R$^{2}$ = %.2f; RMSE = %.2f; slope = %.2f)' % (r1, rmse1,slope1),linewidth=9.3,s=600,color='green')
...
plt.tick_params(axis='both', which='major', pad=20)
plt.xlabel(r'Nutrient limitation from Fisher et al. (2012) (%)',fontsize = 92)
plt.ylabel(r'Normalized C use ratio for nutrient uptake (%)' ,fontsize = 92)

plt.show()
#plt.savefig('scatter_elm_fisher2012_noarid_v4.png',bbox_inches="tight")
...
for i in range(1):
  ...
  #levels=[-0.0051251*max_val,0.,0.0051251*max_val,0.01251*max_val,0.0625*max_val,.1*max_val,.2*max_val,.3*max_val,.4*max_val,.5*max_val,.6*max_val,.7*max_val,.75*max_val,.8*max_val,.9*max_val,1.*max_val]
   ...
   cbar.ax.set_xlabel('C:N ratio', rotation=0,color='black', size=78*1.5)
   ...
   plt.savefig('cn_ratio_fun3.png',bbox_inches="tight")
